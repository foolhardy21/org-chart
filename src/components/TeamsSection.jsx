    ...
    return (
        <div className={`flx flx-column pd-btm-s mg-md ${styles.headerBorder}`}>
            ...
            <section className="flx">
                {
                    headTeams?.map(team => <article key={team.id} className="card-dim card-shadow-xs pd-md mg-xs">
                        ...
                        <div className="flx flx-maj-end mg-top-s">
                            ...
                            <button onClick={() => handleTeamEdit(team.id)} className="btn-txt txt-md txt-off-primary">edit</button>
                        </div>
                    </article>)
                }
